...
<p align="center">
  ...
  <a href="./notebook_examples/llmpic_demo_en.ipynb">Notebook Examples</a>
</p>
...
**Task**: Grouped bar chart — 3 products × 4 quarters, with value labels, custom colors, dashed grid, title, legend.

<table>
<tr>
<td width="50%"><b>Traditional matplotlib — 35 lines</b></td>
<td width="50%"><b>llmpic — 2 lines</b></td>
</tr>
<tr>
<td>
...
lp.bar(
    ...
    "Cloud=[120,145,160,180], "
    "AI=[95,110,130,155], "
    "Security=[140,165,180,200]. "
    "Grouped bars, value labels, "
    "dashed grid, legend."
).style({
...
<tr>
  <td width="50%" align="center">
    ...
    <img src="assets/demo_bar.png" width="95%"/>
  </td>
  <td width="50%" align="center">
    <b>pie — Pie</b><br>
    <code>lp.pie("Market share, explode largest").data(df).save()</code><br>
    <img src="assets/demo_pie.png" width="95%"/>
  </td>
</tr>
<tr>
  <td width="50%" align="center">
    ...
    <img src="assets/demo_heatmap.png" width="95%"/>
  </td>
  <td width="50%" align="center">
    <b>radar — Radar</b><br>
    <code>lp.radar("6-dim capability assessment").data(df).save()</code><br>
    <img src="assets/demo_radar.png" width="95%"/>
  </td>
</tr>
</table>
